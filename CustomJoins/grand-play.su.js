...
function preInit(bot,success){
    const action = [{message:">> Ожидайте завершения проверки...",action:"rec"},{message:"Авторизация | Войдите в игру, введя пароль /login",action:()=>{bot.chat("/l 12341")}},{message:"Авторизация | Зарегистрируйтесь, /register",action:()=>{bot.chat("/reg 12341 12341")}}];
